...
var sum = add(5, 10); // TypeScript infers the type of sum as number
console.log("sum: ".concat(sum, ", type: ").concat(typeof sum)); // sum: 15, type: number
...
var numbers1 = [1, 2, 3, 4, 5]; // TypeScript infers the type as number[]
numbers1.push(6); // TypeScript infers the type of 6 as number
console.log("numbers1: ".concat(numbers1, ", type: ").concat(typeof numbers1)); // numbers1: 1,2,3,4,5,6, type: object
